          ...
          <div className="titleEvents">
            <div className="whizQuiz">
              ...
              <Grid container spacing={24}>
                ...
                <a href="https://goo.gl/KmhB3G" style={{color: "white"}}>Register</a>
                </Grid>
              </Grid>
            </div>
            ...
            <div className="kryptos">
              ...
              <Grid container spacing={24}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <p>Are you a computer wizard? It’s time to Boost up the programmer inside you and stand a chance to win exciting cash prizes.</p>
                  <a href="https://goo.gl/forms/jFe4ha9pDDF8Iquu1" style={{color: "white"}}>Register</a>
                </Grid>
              </Grid>
            </div>
            <div className="lanisters">
              ...
              <Grid container spacing={24}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <a href="https://goo.gl/forms/cDripb9k2YYCc7iI2" style={{color: "white"}}>Register</a>
                </Grid>
              </Grid>
            </div>
          </div>
